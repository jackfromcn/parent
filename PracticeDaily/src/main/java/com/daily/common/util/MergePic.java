...
public class MergePic {
    ...
    public static void main(String[] args) {
        ...
        MergePic tt = new MergePic();

        BufferedImage d = tt.loadImageLocal("/Users/wencheng/Downloads/timg.jpeg");
        BufferedImage b = tt.loadImageLocal("/Users/wencheng/Downloads/百年孤独任务关系图.jpg");
        //往图片上写文件
        //tt.writeImageLocal("E:\\ploanshare\\2\\22.jpg", tt.modifyImage(d, "000000", 90, 90));

        tt.writeImageLocal("/Users/wencheng/Desktop/test_space/parent/PracticeDaily/src/test/11.png", tt.modifyImagetogeter(b, d));
        //将多张图片合在一起
